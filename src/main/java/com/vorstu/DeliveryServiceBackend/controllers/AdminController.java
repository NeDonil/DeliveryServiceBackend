...
public class AdminController {
    ...
    AssemblerDTO addAssembler(@RequestBody @Valid FullAssemblerDTO assembler) {
    ...
    AssemblerDTO updateAssembler(@RequestParam Long assemblerId,
            @RequestBody @Valid FullAssemblerDTO assembler) {
    ...
    @PostMapping("courier")
    CourierDTO addCourier(@RequestBody @Valid FullCourierDTO courier) {
        return courierService.createCourier(courier);
    }

    @PutMapping("courier")
    CourierDTO updateCourier(@RequestParam Long courierId,
            @RequestBody @Valid FullCourierDTO courier) {
